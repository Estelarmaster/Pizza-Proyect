    ...
    <div class="min-h-screen bg-black">
      ...
      <div class="px-6 py-8">
        ...
        <div class="text-center mb-8">
          <div class="relative inline-block">
            ...
            <ng-template #defaultAvatar>
              <div class="w-32 h-32 bg-orange-600 rounded-full flex items-center justify-center border-4 border-orange-400 shadow-xl">
                <span class="text-4xl font-bold text-white">{{ authService.user()?.name?.charAt(0) }}</span>
              </div>
            </ng-template>
          </div>
          <h1 class="text-3xl font-bold text-white mt-4">{{ authService.user()?.name }}</h1>
        ...
        <div class="space-y-4 max-w-md mx-auto">
          <!-- My Profile -->
          <button class="w-full bg-white rounded-xl p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
          ...
          <!-- Track Order -->
          <a routerLink="/orders" class="block w-full bg-white rounded-xl p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
