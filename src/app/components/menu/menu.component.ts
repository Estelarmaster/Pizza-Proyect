        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
          ...
          <div class="max-w-md mx-auto mb-6">
            <div class="relative">
              ...
              />
              <svg
                class="absolute left-3 top-3.5 w-5 h-5 text-gray-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div *ngIf="filteredPizzas().length === 0" class="text-center py-12">
          ...
          >
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0120 12a8 8 0 00-8-8 8 8 0 00-8 8c0 2.047.777 3.91 2.05 5.334z"
            />
          </svg>
  ...
  filteredPizzas = computed(() => {
    ...
    if (this.activeCategory() !== "all") {
      pizzas = pizzas.filter(
        (pizza) => pizza.category === this.activeCategory(),
      );
    }
