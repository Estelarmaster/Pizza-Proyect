          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="relative">
              ...
              >
                ...
                <p class="text-sm text-gray-700 leading-relaxed">
                  {{ homeAddress.address }}, {{ homeAddress.city }},
                  {{ homeAddress.country }}, {{ homeAddress.postalCode }}
                </p>
              </button>
            </div>
            ...
            <div class="relative">
              ...
              >
                ...
                <p class="text-sm text-gray-700 leading-relaxed">
                  {{ officeAddress.address }}, {{ officeAddress.city }},
                  {{ officeAddress.country }}, {{ officeAddress.postalCode }}
                </p>
              </button>
            </div>
          </div>
