          ...
          <div class="p-6">
            ...
            <div class="mb-8">
              ...
              <div class="grid grid-cols-3 gap-4">
                <div
                  *ngFor="let ingredient of pizza()!.ingredients"
                  class="bg-gray-100 rounded-lg p-3 text-center"
                >
                  <div
                    class="w-12 h-12 bg-gray-300 rounded-lg mx-auto mb-2"
                  ></div>
            ...
            <div class="bg-red-600 rounded-2xl p-4 text-white">
              <div class="flex items-center justify-between mb-4">
                <span class="text-2xl font-bold">{{ pizza()!.price | currency:'COP':'symbol':'1.0-0' }}</span>
                ...
                <div class="flex items-center bg-cream-200 rounded-full">
                  ...
                  <span class="px-4 text-amber-900 font-bold text-lg">{{
                    quantity()
                  }}</span>
                  <button
