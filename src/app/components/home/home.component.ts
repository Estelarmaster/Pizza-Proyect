...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100">
      ...
      <div *ngIf="isLoading()" class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-yellow-200 to-orange-300">
        <div class="text-center space-y-8">
          <!-- Pizza Graphics -->
          <div class="relative">
            <div class="absolute -top-16 -left-16 w-32 h-32 rounded-full bg-orange-400 opacity-70 animate-pulse"></div>
            ...
            <div class="absolute -bottom-8 -right-8 w-24 h-24 rounded-full bg-red-400 opacity-60 animate-bounce"></div>
          </div>
          ...
          <div class="flex justify-center space-x-4">
            <div class="w-8 h-8 bg-yellow-400 rounded-full transform rotate-45"></div>
            <div class="w-6 h-6 bg-red-400 rounded-full"></div>
            <div class="w-8 h-8 bg-green-400 rounded-full transform rotate-12"></div>
          </div>
        </div>
      </div>
      ...
      <div *ngIf="!isLoading()" class="min-h-screen">
        <!-- Hero Section -->
        <section class="relative h-screen flex items-center justify-center bg-gradient-to-br from-orange-400 via-red-500 to-pink-500">
          <div class="absolute inset-0 bg-black opacity-30"></div>
          
          <!-- Pizza Background Pattern -->
          <div class="absolute inset-0 opacity-10">
            <div class="absolute top-20 left-20 w-32 h-32 rounded-full border-4 border-white"></div>
            <div class="absolute bottom-32 right-32 w-24 h-24 rounded-full border-2 border-white"></div>
        ...
        <section class="py-20 bg-white">
          <div class="max-w-6xl mx-auto px-6">
            <h2 class="text-4xl font-bold text-center mb-16 text-gray-800">¿Por qué elegir Mozzarella?</h2>
            ...
            <div class="grid md:grid-cols-3 gap-12">
              <div class="text-center">
                ...
                <p class="text-gray-600">Entregamos tu pizza caliente en menos de 30 minutos</p>
              </div>
              ...
              <div class="text-center">
                ...
                <p class="text-gray-600">Solo usamos los ingredientes más frescos y de la mejor calidad</p>
              </div>
              ...
              <div class="text-center">
                ...
                <p class="text-gray-600">Cada pizza es preparada con cariño por nuestros chefs expertos</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="py-20 bg-gradient-to-r from-red-600 to-orange-600">
          <div class="max-w-4xl mx-auto text-center px-6">
            <h2 class="text-4xl font-bold text-white mb-6">¿Listo para ordenar?</h2>
